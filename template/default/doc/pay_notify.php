    ...
    <div id="body">
        <div id="content_body" name="content_body" style="width:100%;height:100%;border:none;overflow: auto;">
            <div id="article-content" class="markdown-body">
                ...
                <h1 id="支付结果通知"><a href="#支付结果通知">支付结果通知</a></h1><h4 id="通知类型："><a href="#通知类型：">通知类型：</a></h4><p>服务器异步通知（notify_url）、页面跳转通知（return_url）</p><h4 id="请求方式："><a href="#请求方式：">请求方式：</a></h4><p>GET</p><h4 id="请求参数说明："><a href="#请求参数说明：">请求参数说明：</a></h4><table><thead><tr><th align="left">字段名</th><th align="left">变量名</th><th align="left">类型</th><th align="left">示例值</th><th align="left">描述</th></tr></thead><tbody><tr><td align="left">商户ID</td><td align="left">pid</td><td align="left">Int</td><td align="left">1001</td><td align="left"> </td></tr><tr><td align="left">平台订单号</td><td align="left">trade_no</td><td align="left">String</td><td align="left">20160806151343349</td><td align="left"> </td></tr><tr><td align="left">商户订单号</td><td align="left">out_trade_no</td><td align="left">String</td><td align="left">20160806151343351</td><td align="left"> </td></tr><tr><td align="left">接口订单号</td><td align="left">api_trade_no</td><td align="left">String</td><td align="left">40001249985198893</td><td align="left">微信支付宝返回的单号</td></tr><tr><td align="left">支付方式</td><td align="left">type</td><td align="left">String</td><td align="left">alipay</td><td align="left"><a href="./paytype.html">支付方式列表</a></td></tr><tr><td align="left">交易状态</td><td align="left">trade_status</td><td align="left">String</td><td align="left">TRADE_SUCCESS</td><td align="left">固定为TRADE_SUCCESS</td></tr><tr><td align="left">订单创建时间</td><td align="left">addtime</td><td align="left">String</td><td align="left">2024-07-01 16:47:32</td><td align="left"> </td></tr><tr><td align="left">订单完成时间</td><td align="left">endtime</td><td align="left">String</td><td align="left">2024-07-01 16:49:24</td><td align="left">仅完成才返回</td></tr><tr><td align="left">商品名称</td><td align="left">name</td><td align="left">String</td><td align="left"> </td><td align="left"> </td></tr><tr><td align="left">商品金额</td><td align="left">money</td><td align="left">String</td><td align="left">1.00</td><td align="left"> </td></tr><tr><td align="left">业务扩展参数</td><td align="left">param</td><td align="left">String</td><td align="left"> </td><td align="left"> </td></tr><tr><td align="left">支付用户标识</td><td align="left">buyer</td><td align="left">String</td><td align="left"> </td><td align="left">一般为openid</td></tr><tr><td align="left">当前时间戳</td><td align="left">timestamp</td><td align="left">String</td><td align="left">1721206072</td><td align="left">10位整数，单位秒</td></tr><tr><td align="left">签名字符串</td><td align="left">sign</td><td align="left">String</td><td align="left"> </td><td align="left">参考签名规则</td></tr><tr><td align="left">签名类型</td><td align="left">sign_type</td><td align="left">String</td><td align="left">RSA</td><td align="left">默认为RSA</td></tr></tbody></table><h4 id="返回内容说明："><a href="#返回内容说明：">返回内容说明：</a></h4><p>收到异步通知后，需返回success以表示服务器接收到了订单通知</p><h4 id="其他说明："><a href="#其他说明：">其他说明：</a></h4><ul><li>商户系统代码内务必对返回的签名sign进行校验，并且判断trade_status的值是否等于TRADE_SUCCESS</li><li>支付平台可能会增加回调字段，验证签名时必须支持增加的扩展字段</li></ul>            <div id="mask" style="display:none" onclick="clickMask()"></div>
            </div>
        </div>
    </div>
