    ...
    <div id="body">
        <div id="content_body" name="content_body" style="width:100%;height:100%;border:none;overflow: auto;">
            <div id="article-content" class="markdown-body">
                ...
                <h1 id="查询订单列表"><a href="#查询订单列表">查询订单列表</a></h1><blockquote>查询订单列表可用于对账或同步订单状态等</blockquote><h4 id="请求地址："><a href="#请求地址：">请求地址：</a></h4><p><code><?php echo h($conf['apiurl'])?>api/merchant/orders</code></p><h4 id="请求方式："><a href="#请求方式：">请求方式：</a></h4><p>POST</p><h4 id="请求参数说明："><a href="#请求参数说明：">请求参数说明：</a></h4><table><thead><tr><th align="left">字段名</th><th align="left">变量名</th><th align="left">必填</th><th align="left">类型</th><th align="left">示例值</th><th align="left">描述</th></tr></thead><tbody><tr><td align="left">商户ID</td><td align="left">pid</td><td align="left">是</td><td align="left">Int</td><td align="left">1001</td><td align="left"> </td></tr><tr><td align="left">查询偏移</td><td align="left">offset</td><td align="left">是</td><td align="left">Int</td><td align="left">0</td><td align="left">从0开始</td></tr><tr><td align="left">每页条数</td><td align="left">limit</td><td align="left">是</td><td align="left">Int</td><td align="left">50</td><td align="left">最大不能超过50</td></tr><tr><td align="left">过滤订单状态</td><td align="left">status</td><td align="left">否</td><td align="left">Int</td><td align="left">1</td><td align="left">0：未支付，1：已支付</td></tr><tr><td align="left">当前时间戳</td><td align="left">timestamp</td><td align="left">是</td><td align="left">String</td><td align="left">1721206072</td><td align="left">10位整数，单位秒</td></tr><tr><td align="left">签名字符串</td><td align="left">sign</td><td align="left">是</td><td align="left">String</td><td align="left"> </td><td align="left">参考签名规则</td></tr><tr><td align="left">签名类型</td><td align="left">sign_type</td><td align="left">是</td><td align="left">String</td><td align="left">RSA</td><td align="left">默认为RSA</td></tr></tbody></table><h4 id="返回参数说明："><a href="#返回参数说明：">返回参数说明：</a></h4><table><thead><tr><th align="left">字段名</th><th align="left">变量名</th><th align="left">类型</th><th align="left">示例值</th><th align="left">描述</th></tr></thead><tbody><tr><td align="left">返回状态码</td><td align="left">code</td><td align="left">Int</td><td align="left">0</td><td align="left">0为成功，其它值为失败</td></tr><tr><td align="left">返回信息</td><td align="left">msg</td><td align="left">String</td><td align="left"> </td><td align="left">失败或成功时返回提示</td></tr><tr><td align="left">订单列表</td><td align="left">data</td><td align="left">Array</td><td align="left"> </td><td align="left">具体参数可参考<a href="pay_query.html">订单查询</a></td></tr><tr><td align="left">当前时间戳</td><td align="left">timestamp</td><td align="left">String</td><td align="left">1721206072</td><td align="left">10位整数，单位秒</td></tr><tr><td align="left">签名字符串</td><td align="left">sign</td><td align="left">String</td><td align="left"> </td><td align="left">参考签名规则</td></tr><tr><td align="left">签名类型</td><td align="left">sign_type</td><td align="left">String</td><td align="left">RSA</td><td align="left">默认为RSA</td></tr></tbody></table>            <div id="mask" style="display:none" onclick="clickMask()"></div>
            </div>
        </div>
    </div>
