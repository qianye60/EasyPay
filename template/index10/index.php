...
<html>
	...
	<body aos-easing="ease-out-back" aos-duration="1000" aos-delay="0">
     ...
     <header class="index_header">
			...
			<div class="navBox">
				<div class="logo left">
					<img src="assets/img/logo.png" alt="<?php echo h($conf['sitename'])?>" draggable="false">
				</div>
				<div class="navBox_right right">
					<ul class="nav left">
												...
												<li class="left"><a href="https://wpa.qq.com/msgrd?v=3&uin=<?php echo h($conf['kfqq'])?>&site=pay&menu=yes" rel="nofollow">联系我们</a></li>
...
<!-- 						<a class="banner_btnContact animated wobble xs_li_07" href="javascript:;" style="position: relative;">
					...
					<div class="banner_right right animated bounceInRight">
						<img src="<?php echo STATIC_ROOT?>picture/banner_right.png" alt="<?php echo h($conf['sitename'])?>-一个好用的免签约支付接口" draggable="false">
					</div>
				</div>
			</div>
		</header>
			...
			<div aos="zoom-in" class="payment_box animated zoomIn">
				<ul class="payment_ul">
					<li class="left payment_item1">
						<a href="javascript:;">
							<img class="img1" src="<?php echo STATIC_ROOT?>picture/payment_1.png" alt="<?php echo h($conf['sitename'])?>-免签约支付宝扫码H5支付" draggable="false" />
						</a>
					</li>
					<li class="left payment_item2">
						<a href="javascript:;">
							<img class="img1" src="<?php echo STATIC_ROOT?>picture/payment_2.png" alt="<?php echo h($conf['sitename'])?>-免签约微信扫码公众号H5支付" draggable="false" />
						</a>
					</li>
					<li class="left payment_item3">
						<a href="javascript:;">
							<img class="img1" src="<?php echo STATIC_ROOT?>picture/payment_3.png" alt="<?php echo h($conf['sitename'])?>-银联在线快捷支付" draggable="false" />
						</a>
					</li>
					<li class="left payment_item4">
						<a href="javascript:;">
							<img class="img3" src="<?php echo STATIC_ROOT?>picture/payment_4.png" alt="<?php echo h($conf['sitename'])?>-QQ钱包免签约扫码H5支付" draggable="false" />
						</a>
					</li>
					<li class="left payment_item5">
						<a href="javascript:;">
							<img class="img3" src="<?php echo STATIC_ROOT?>picture/payment_5.png" alt="<?php echo h($conf['sitename'])?>-免签约京东支付" draggable="false" />
						</a>
					</li>
					<li class="left payment_item6">
						<a href="javascript:;">
							<img class="img3" src="<?php echo STATIC_ROOT?>picture/payment_6.png" alt="<?php echo h($conf['sitename'])?>-免签约百度钱包支付" draggable="false" />
						</a>
					</li>
					<li class="left payment_item7">
						<a href="javascript:;">
							<img class="img2" src="<?php echo STATIC_ROOT?>picture/payment_7.png" alt="<?php echo h($conf['sitename'])?>-免签约财付通支付" draggable="false" />
						</a>
					</li>
		...
		<div class="about">
			<div class="center">
				<div aos="zoom-in" class="about_main aos-init aos-animate">
					<span class="title_common about_title pingFang"><?php echo h($conf['sitename'])?>简介</span>
					<span class="about_line right"></span>
					<div class="about_txt">
						<p class="pingFang"><?php echo h($conf['orgname'])?>成立于2018年，<?php echo h($conf['sitename'])?>（<?php echo htmlspecialchars($_SERVER['HTTP_HOST'])?>）。</p>
						<p class="pingFang"><?php echo h($conf['sitename'])?>平台主要服务于互联网和移动互联网领域，为网页游戏、手机游戏、阅读、音乐、交友、教育等移动应用提供综合计费营销服务，创新、诚信、灵和活多元,创新是企业发展的灵魂。</p>
		...
		<div aos="zoom-in" class="process aos-init aos-animate">
			<div class="center">
				<div class="process_main">
					<span class="title_common process_title pingFang animated slideInUp">成为<?php echo h($conf['sitename'])?>商户仅需六步</span>
					<span class="process_line animated zoomIn"></span>
					<span class="process_h4 pingFang animated slideInDown"><?php echo h($conf['sitename'])?>让你轻松做生意</span>
					<ul class="process_ul">
						<li class="left animated bounceInLeft">
							<img src="<?php echo STATIC_ROOT?>picture/process_1.png" alt="<?php echo h($conf['sitename'])?>-注册商户-在线自助注册" draggable="false" />
							<span class="process_txt1 pingFang">注册商户</span>
							<span class="process_txt2 pingFang">在线自助注册</span>
						</li>
						<li class="left animated bounceInLeft">
							<img src="<?php echo STATIC_ROOT?>picture/process_2.png" alt="<?php echo h($conf['sitename'])?>-绑定银行-轻松设置商户信息" draggable="false" />
							<span class="process_txt1 pingFang">绑定银行</span>
							<span class="process_txt2 pingFang">轻松设置商户信息</span>
						</li>
						<li class="left animated bounceInLeft">
							<img src="<?php echo STATIC_ROOT?>picture/process_3.png" alt="<?php echo h($conf['sitename'])?>-接口对接-全平台SDK支持" draggable="false" />
						...
						<li class="left animated bounceInRight">
							<img src="<?php echo STATIC_ROOT?>picture/process_4.png" alt="<?php echo h($conf['sitename'])?>-自助下单-会员支付一键直达" draggable="false" />
							<span class="process_txt1 pingFang">自助下单</span>
							<span class="process_txt2 pingFang">会员支付一键直达</span>
						</li>
						<li class="left animated bounceInRight">
							<img src="<?php echo STATIC_ROOT?>picture/process_5.png" alt="<?php echo h($conf['sitename'])?>-全天客服-7*24小时专业服务" draggable="false" />
							<span class="process_txt1 pingFang">全天客服</span>
							<span class="process_txt2 pingFang">7*24小时专业服务</span>
						</li>
						<li class="left animated bounceInRight">
							<img src="<?php echo STATIC_ROOT?>picture/process_6.png" alt="<?php echo h($conf['sitename'])?>-自动结算-信誉无忧充分保障" draggable="false" />
		...
		<div class="advantage" id="advantage">
			...
			<div class="center">
				<ul class="advantage_botMain">
					<li class="left">
						<img aos="zoom-in-up" class="aos-init aos-animate" src="<?php echo STATIC_ROOT?>picture/advantage_1.png" alt="<?php echo h($conf['sitename'])?>-服务器安全、速度、稳定" draggable="false" />
					...
					<li class="left li_margin">
						<img aos="zoom-in-up" class="aos-init aos-animate" src="<?php echo STATIC_ROOT?>picture/advantage_2.png" alt="<?php echo h($conf['sitename'])?>-资金安全有保障" draggable="false" />
					...
					<li class="left li_margin">
						<img aos="zoom-in-up" class="aos-init aos-animate" src="<?php echo STATIC_ROOT?>picture/advantage_3.png" alt="<?php echo h($conf['sitename'])?>-持续更新用的安心" draggable="false" />
					...
					<li class="left">
						<img aos="zoom-in-up" class="aos-init aos-animate" src="<?php echo STATIC_ROOT?>picture/advantage_4.png" alt="<?php echo h($conf['sitename'])?>-界面简约，操作简单" draggable="false" />
					...
					<ul aos="zoom-in-up" class="contactUs_main aos-init aos-animate">
						...
						<li class="left contactUs_liMargin2">
							...
							<span class="contactUs_mainLine"></span>
								...
								<a href="https://wpa.qq.com/msgrd?v=3&uin=<?php echo h($conf['kfqq'])?>&site=pay&menu=yes" rel="nofollow"target="_blank" class="contactUs_mainTxt pingFang">商务QQ：<?php echo h($conf['kfqq'])?></a>
							<span class="contactUs_mainBot"></span>
						</li>
						<li class="left contactUs_liMargin1">
							...
							<span class="contactUs_mainLine"></span>
							<span class="contactUs_mainTxt pingFang"><?php echo h($conf['email'])?></span>
							<span class="contactUs_mainBot"></span>
						</li>
					</ul>
				</div>
			...
			<div class="footer_top">
				<ul class="footer_topLeft left">
					...
					<li class="left">
						...
						<div class="footer_topLeftCon pingFang">
							...
							<a href="https://wpa.qq.com/msgrd?v=3&uin=<?php echo h($conf['kfqq'])?>&site=pay&menu=yes" rel="nofollow">联系我们</a>
						</div>
					</li>
				</ul>
				<div class="footer_topRight right">
					...
					<div class="footer_detail left pingFang">
						...
						<p class="footer_pCom footer_email"><?php echo h($conf['email'])?></p>
						<p class="footer_pCom footer_qq"> <a href="https://wpa.qq.com/msgrd?v=3&uin=<?php echo h($conf['kfqq'])?>&site=pay&menu=yes"rel="nofollow" target="_blank" style="color: #666666;"><?php echo h($conf['kfqq'])?></a></p>
					</div>
					<div></div>
				</div>
			</div>
			<div class="footer_bottom pingFang"> Copyright © <?php echo date("Y")?> <?php echo h($conf['sitename'])?> All rights reserved. 版权所有
...
<!-- wpa start -->  
		...
		<div class="right_common right_conBox">
				<div class="right_qqShow rightShow_common">
					...
					<div class="rightNum_comm right_tellNum left"><?php echo h($conf['kfqq'])?></div>-
					<a href="https://wpa.qq.com/msgrd?v=3&uin=<?php echo h($conf['kfqq'])?>&site=pay&menu=yes" rel="nofollow"target="_blank" class="rightNum_comm right_tellNum left"><?php echo h($conf['kfqq'])?></a>
				</div>
