...
<html lang="zh-cn">
    ...
    <body>
        <div class="main">
            <div class="bg-douyin"></div>
            <div class="payment-logo payment-logo-douyin">
                <img src="/assets/pay/icon/douyinpay-white.png" alt="logo">
            </div>
                ...
                <div class="scan-the-code">
                    ...
                    <div class="list-group">
                        <div class="list-group-item text-center">
                            <h5 class="qr-title">请使用抖音APP扫描二维码支付</h5>
                            <div class="qr-image" id="qrcode"></div>
                            <div class="operate">
                                <a href="snssdk1128://" class="btn btn-default">
                        ...
                        <div class="list-group-item">
                            <small>提示：你可将以上二维码链接发到自己抖音的聊天框（在抖音消息页面顶部搜索框可以搜到自己的账号），点击即可进入支付！</small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
            ...
            function loadmsg() {
                $.ajax({
                    ...
                    dataType: "json",
                    url: "/getshop.php",
                    data: {type: "douyinpay", trade_no: "<?php echo $order['trade_no'] ?>"},
